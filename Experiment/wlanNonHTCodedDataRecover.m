function [codedbits, varargout] = wlanNonHTCodedDataRecover( ...
...
%% TODO, use APP decoder for channel decoding here. -- Lihao
% Demap and decode
[codedbits,codingRate,PSDULength] = wlanNonHTCodedBitRecover(eqDataSym,noiseVarEst,csiData,cfgNonHT);
varargout{2} = codingRate;
varargout{3} = PSDULength;
end