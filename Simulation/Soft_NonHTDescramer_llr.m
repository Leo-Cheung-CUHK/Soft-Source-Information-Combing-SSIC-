function [psdu_llr,txBits,errorBits,pass] = Soft_NonHTDescramer_llr(PSDULength,a_total,f_total,r_total,yllr,L,mpdu)
%% Initialization
...
for i=(1+L):size(yllr,1)
    ...
    Pdot_z0_i = Pdot_z0_i/(Pdot_z0_i+Pdot_z1_i);
    Pdot_z1_i = Pdot_z1_i/(Pdot_z0_i+Pdot_z1_i);
...
%descramDataOut = double((xllr<0));

% Remove the 16 service bits + 111 zeros bits
if L >=16
    psdu_llr = xllr(L+1:end);
